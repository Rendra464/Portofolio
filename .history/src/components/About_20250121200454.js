                    ...
                    <ul className="experience-list">
                        ...
                        <li className="experience-card">
                            ...
                            <div className="experience-details">
                                ...
                                <p className="experience-duration">Freelance | 2022</p>
                                <p className="experience-description">
                                    Designed and developed a user-friendly cafe website, including an interactive menu and online booking features, using Laravel and Vite.
                                </p>
                            </div>
                        </li>
                        <li className="experience-card">
                            ...
                            <div className="experience-details">
                                ...
                                <p className="experience-duration">Freelance | 2022</p>
                                <p className="experience-description">
                                    Built a responsive travel website with integrated APIs for real-time ticket booking and map navigation.
                                </p>
                            </div>
                        </li>
                    </ul>
